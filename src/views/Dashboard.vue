        ...
        <v-row>
            <v-col lg="7" cols="12">
                <v-alert dense text type="success">
                    Logado com sucesso! Bem vindo ao meu <strong>Dashboard</strong>
                </v-alert>
                <v-row>
                        ...
                        <v-timeline align-top dense>
                            <v-timeline-item color="indigo" small>
                                ...
                                <div class="text-caption">
                                    Você tem um novo pedido, verifique isto
                                </div>
                            </v-timeline-item>
                            <v-timeline-item color="green" small>
                                <strong>35 Minutos atrás</strong>
                                <div class="text-caption mb-2">
                                    Um produto foi entregue!
                                </div>
                            </v-timeline-item>
            ...
            <v-col>
                <v-card>
                    <v-data-table
                            caption="Ordem listagem recente"
                            :headers="headers"
                            :items="desserts"
                            :items-per-page="5"
                            class="elevation-1"
                    >
                        <template v-slot:item.action="">
                            <v-btn color="Sucesso" outlined small shaped >View</v-btn>
                        </template>
                    </v-data-table>
                </v-card>
            </v-col>
